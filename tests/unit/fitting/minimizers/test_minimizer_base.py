...
class TestMinimizerBase:
    ...
    def minimizer(self):
        ...
        minimizer = MinimizerBase(
            obj='obj', fit_function='fit_function', minimizer_enum=self._mock_minimizer_enum
        )
        return minimizer
    ...
    def test_evaluate(self, minimizer: MinimizerBase):
        ...
        minimizer._prepare_parameters = MagicMock(
            return_value={'prepared_parms_key': 'prepared_parms_val'}
        )
    ...
    def test_create_signature(self, minimizer: MinimizerBase) -> None:
        ...
        wrapped_parameters = [
            ...
            InspectParameter(
                'p1', InspectParameter.POSITIONAL_OR_KEYWORD, annotation=_empty, default=1.0
            ),
            InspectParameter(
                'p2', InspectParameter.POSITIONAL_OR_KEYWORD, annotation=_empty, default=2.0
            ),
        ]
