...
class TestLMFit():
    ...
    def test_fit(self, minimizer: LMFit) -> None:
        ...
        mock_model.fit.assert_called_once_with(2.0, x=1.0, weights=0.7071067811865475, max_nfev=None, method='leastsq')
    ...
    def test_fit_method(self, minimizer: LMFit) -> None:
        ...
        # Expect
        mock_model.fit.assert_called_once_with(2.0, x=1.0, weights=0.7071067811865475, max_nfev=None, method='method_passed')
    ...
    def test_fit_kwargs(self, minimizer: LMFit) -> None:
        ...
        # Expect
        mock_model.fit.assert_called_once_with(2.0, x=1.0, weights=0.7071067811865475, max_nfev=None, method='leastsq', fit_kws={'minimizer_key': 'minimizer_val'}, engine_key='engine_val')
