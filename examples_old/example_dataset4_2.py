...
d.easyscience.add_coordinate('x1', x)
d.easyscience.add_variable('y1', ['x1'], y1, auto_sigma=True)
d.easyscience.add_coordinate('x2', x2)
d.easyscience.add_variable('y2', ['x2'], y2, auto_sigma=True)

res = d.easyscience.fit(f, ['y1', 'y2'])
